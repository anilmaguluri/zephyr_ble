...
static uint32_t requested_subgroup_sync;
					  ...
					  void *user_data)
{
	...
	data->bis[idx].chan_allocation = chan_allocation;
					      ...
					      void *user_data)
{
	...
	data.bap_base_codec_id.id = codec_cfg.id;
	data.bap_base_codec_id.cid = codec_cfg.cid;
	data.bap_base_codec_id.vid = codec_cfg.vid;
	data.cnt = 0;
